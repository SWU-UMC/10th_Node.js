...
import { createReview, handleListStoreReviews, handleMyReviews, } from "./modules/reviews/controllers/review.controller.js";
import { createMission, handleStoreMissions, challengeMission, handleMyMissions, completeMission, } from "./modules/missions/controllers/mission.controller.js";
dotenv.config();
const app = express();
...
app.post("/api/v1/user-missions/:userMissionId/complete", completeMission);
app.listen(port, () => {
